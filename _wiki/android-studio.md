...
![jump from class to layout](https://mazhuang.org/images/wiki/jump-from-class-to-layout.jpg)

在 Layout XML 文件里点击根节点前的小图标跳转到关联的 Activity/Fragment：

![jump from layout to class](https://mazhuang.org/images/wiki/jump-from-layout-to-class.jpg)
...
![code generation naming](https://mazhuang.org/images/wiki/code-generation-naming.png)
